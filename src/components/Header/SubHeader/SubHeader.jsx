...
import DropdownContent from "../../DropDownStore/DropDownStore";
...
const SubHeader = () => {
  ...
  return (
    <>
      <header className="nav-hide-or-view flex justify-center items-center text-accent-black h-[48px] border-t border-gray-400 w-full">
        <div className="flex justify-between  space-x-10  ">
          <div className="text-sm  font-bold inline-flex items-center  text-red ">
            <span onClick={()=> toggleDropdown("dropDownStore")} className="ml-1 inline-flex items-center cursor-pointer  border-b-4 border-red">
              <svg
                className="mr-1.5 mt-[2px]"
                viewBox="0 0 32 32"
              ...
              My Nintendo Store{" "}
              <IoIosArrowDown className="w-[20px] h-[20px]  mt-1 ml-1" />
           
           
            </span>
            <DropdownContent isOpen={isDropdownOpen.dropDownStore} setIsOpen={()=> toggleDropdown("dropDownStore")} />
          </div>
          

          <div className="text-sm  font-bold inline-flex items-center text-accent-black hover:text-red transition-colors duration-300 ">
            <span onClick={()=> toggleDropdown("dropDownGames")} className="ml-1 inline-flex items-center cursor-pointer  ">
              <svg
                className="mr-1.5 mt-[2px]"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
              ...
              Games <IoIosArrowDown className="w-[20px] h-[20px]  mt-1 ml-1" />
            </span>
            <DropDown isOpen={isDropdownOpen.dropDownGames} setIsOpen={()=> toggleDropdown("dropDownGames")} />
          </div>

          <div className="text-sm  font-bold inline-flex items-center text-accent-black hover:text-red transition-colors duration-300 ">
            <span className="ml-1 inline-flex items-center cursor-pointer ">
              <svg
                className="mr-1.5 mt-[2px]"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
